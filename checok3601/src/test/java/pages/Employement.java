...
public class Employement {
	...
	public static void adddata(WebDriver driver, int end, int endpoint) throws InterruptedException {
		...
		WebElement drop = driver.findElement(By.id("ctl00_ContentPlaceHolder1_ddlEmploymentCompany_Input"));
		drop.clear();
		drop.sendKeys("tcs");
		Thread.sleep(1000);
		...
		Thread.sleep(2000);
		driver.findElement(By.id("ctl00_ContentPlaceHolder1_txtEmployeeDesignation")).sendKeys("Senior Developer");
		WebElement save = driver.findElement(By.id("ctl00_ContentPlaceHolder1_btnEmploymentSubmit_input"));
