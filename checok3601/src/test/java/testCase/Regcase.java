...
public class Regcase {
	...
	@BeforeTest
	public void start() {
		extent = new ExtentReports ("/home/ganesh/eclipse-workspace/checks/reports/STMExtentReport.html", true);
		extent
		...
		System.setProperty("webdriver.firefox.marionette", "/home/ganesh/Desktop/gopinath/driver/geckodriver");
		 extent.loadConfig(new File("/home/ganesh/eclipse-workspace/checks/reports/extent-config.xml"));
